...
puntos_encargado = {'No, las tareas se asignarán sobre la marcha.': 6, 'Sí, una persona сon poca experiencia en proyectos, en su tiempo libre.': 4, 'Sí, una persona сon experiencia, pero que está bastante ocupada.': 2, 'No, queremos que el consultor lo vea todo.': 1}
